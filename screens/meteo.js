          ...
          <Card>
              ...
              {main.temp > 35 ? (
                ...
                >
                  <FontAwesome5
                    ...
                    color="#f57c00"
                  />
                  <Text style={{ fontSize: 20 }}>{main.temp} température</Text>
                </View>
              ) : (
                <View></View>
              )}
            ...
            <CardItem bordered>
              <Body>
                ...
                >
                  <Feather name="wind" size={30} color="#2196f3" />
                  <Text style={{ fontSize: 20 }}>{wind.speed} vitesse de vent km/h</Text>
                </View>
              </Body>
            </CardItem>
            <CardItem bordered>
              <Body>
                ...
                >
                  <MaterialCommunityIcons
                    ...
                    color="#2196f3"
                  />
                  <Text style={{ fontSize: 20 }}>{main.humidity} humidité</Text>
                </View>
              </Body>
            </CardItem>
            <CardItem bordered>
